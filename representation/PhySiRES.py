...
class SignalEncoder(nn.Module):
    ...
    def __init__(self, output_size, dropout, seq):
        super().__init__()
...
class MultiSignalEncoder(nn.Module):
    def __init__(self, output_size, dropout=0.1, seq=400) -> None:
        ...
        self.bvp_encoder = SignalEncoder(self.output_size, dropout, self.seq)
        self.eda_encoder = SignalEncoder(self.output_size, dropout, self.seq)
